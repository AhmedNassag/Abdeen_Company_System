...
<html
  ...
  <head>
    ...
    <title>Request-task-report</title>
               ...
               <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      ...
                      <strong class="py-3 px-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   تقرير المهام اليومي
                      </span>  </strong>
                              ...
                              <div class="col-sm-7">
                                <form class="row component-form  mt-4  mb-4 pt-4 align-items-center justify-content-center">
                                 ...
                                 <div class="mb-3 col-11 col-lg-11 col-xl-8">
                                  <a class="btn btn-primary  waves-effect waves-light" href="all-task-report">عرض التقارير</a>
                                 </div>
