...
<head>
  ...
  <title>all-view-statistics</title>
            ...
            <div class="card comonent-hader-top">
              ...
              <div class="card mb-4">
                <div class="card-body p-4">
                  <strong class="text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">كل الاحصائيات</span>
                  </strong>
                  <div class="row row-cols-lg-2
               row-col-md-2 row-cols-1 mt-4 g-3">
                    <!--card-->
                    <div class="col">
                      <div class="card card-border-shadow-success">
                        <div class="card-body">
                          <h6 class="fw-bold fs-4">هل انت راضى عن الخدمة؟</h6>
                          <div class="row row-cols-md-2  row-cols-1 align-items-center justify-content-center">
                            <div class="col">
                              <p>عدد الذين قالو نعم:<span class="fw-bold">6</span></p>
                              <p>عدد الذين قالو لا:<span class="fw-bold">0</span></p>
                    ...
                    <div class="col">
                      <div class="card card-border-shadow-success">
                        <div class="card-body">
                          <h6 class="fw-bold fs-4"> اقتراح لى تحسين الخدمة </h6>
                          <div class="row row-cols-md-2  row-cols-1 align-items-center justify-content-center">
                            <div class="col">
                              <ul>
                                <li>fffffff</li>
                    ...
                    <div class="col">
                      <div class="card card-border-shadow-success">
                        <div class="card-body">
                          <h6 class="fw-bold fs-4">قيم نسبة رضاك عن الخدمة</h6>
                          <div class="row row-cols-md-2  row-cols-1 align-items-center justify-content-center">
                            <div class="col">
                              <p>عدد التقيمات:<span class="fw-bold">6</span></p>
                              <p> معدل التقيمات:<span class="fw-bold">0</span></p>

                            </div>
                            <div class="col">
                              <div id="piechart-there"></div>
                    ...
                    <div class="col">
                      <div class="card card-border-shadow-success">
                        <div class="card-body">
                          <h6 class="fw-bold fs-4"> مارايك بالخدمة؟</h6>
                          <div class="row row-cols-md-2  row-cols-1 align-items-center justify-content-center">
                            <div class="col">
                              <p>عدد التقيمات:<span class="fw-bold">6</span></p>
                              <p> معد التقيمات:<span class="fw-bold">0</span></p>

                            </div>
                            <div class="col">
                              <div id="piechart-for"></div>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col">
                      <div class="card card-border-shadow-success">
                        <div class="card-body">
                          <h6 class="fw-bold fs-4"> هل ترشح الخدمة لاحد معارفك</h6>
                          <div class="row row-cols-md-2  row-cols-1 align-items-center justify-content-center">
                            <div class="col">
                              <p> نعم ارشح:<span class="fw-bold">6</span></p>
                              <p> لا ارشح:<span class="fw-bold">0</span></p>

                            </div>
                            <div class="col">
                              <div id="piechart-fife"></div>
                            </div>
                          </div>
                        </div>
                      </div>
