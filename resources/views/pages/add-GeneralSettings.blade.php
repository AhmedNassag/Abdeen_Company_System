    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
        ...
        <!-- Layout container -->
               ...
               <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                       ...
                       <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                        ...
                        <div class="col text-end">
                          <a href="GeneralSettings" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
                    ...
                    <form class="row component-form">
                      ...
                      <div class="col-12 col-md-4 mb-3">
                        ...
                        <div class="input-groupe">
                          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-consultation">
                  ...
                  <div class="col-12 col-md-4 mb-3">
                    ...
                    <div class="input-groupe">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-Responsible">
                        <i class="fa-solid fa-plus"></i>
                      </button>
           ...
           <!---->
               <!-- Modal   اضافه استشارة-->
               <div class="modal fade" id="add-consultation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"role="dialog" style="z-index: 1600;">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة   استشارة</h1>
                    ...
                    <div class="modal-body">
                      <form class="row component-form align-items-end mx-0">
                        ...
                        <div class="col-12 col-lg-12  mb-3">
                          <label class="form-label" for="basic-name-hardware">   اسم استشارة   (عربى)</label>
                          <input type="text" class="form-control" id="basic-name-hardware">
  
                        </div>
                        <div class="col-12 col-lg-12  mb-3">
                          <label class="form-label" for="basic-name-hardware-e">    اسم استشارة  (انجيلزي)</label>
             ...
             <!---->
            <!-- Modal   اضافه مبيعات-->
            <div class="modal fade" id="add-sales" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"role="dialog" style="z-index: 1600;">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة مسؤول  مبيعات </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form class="row component-form align-items-end mx-0">
                      ...
                      <div class="col-12 col-lg-12  mb-3">
                        <label class="form-label" for="basic-name-hardware">   اسم شخص   (عربى)</label>
                        <input type="text" class="form-control" id="basic-name-hardware">

                      </div>
                      <div class="col-12 col-lg-12  mb-3">
                        <label class="form-label" for="basic-name-hardware-e">    اسم شخص  (انجيلزي)</label>
                        <input type="text" class="form-control" id="basic-name-hardware-e">
             ...
             <!---->
                <!-- Modal   اضافه مبيعات-->
            <div class="modal fade" id="add-Responsible" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"role="dialog" style="z-index: 1600;">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة فنى   </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form class="row component-form align-items-end mx-0">
