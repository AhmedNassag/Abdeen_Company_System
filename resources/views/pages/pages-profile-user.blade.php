...
<html
  ...
  <head>
    ...
    <title>pages-profile-user</title>
                  ...
                  <div class="col-xl">
                    <div class="card mb-4">
                      <div class="card-body p-4">
                           <strong class="col-xl-2 col-lg-4 col-md-4 mb-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium"> الملف الشخصى</span>  </strong>
                           <form class="row component-form align-items-end mt-4">
                            <div class="img-porfoil mb-3">
                              <div class="avatar-edit">
                                <input type='file' id="imageUpload" accept=".png, .jpg, .jpeg" />
                                <label for="imageUpload">
                                 <img src="./assets/img/avatars/pen.png" style="width: 25px;">

                                </label>
                              </div>
                              <div class="avatar-preview">
                                <div id="imagePreview" style="background-image: url(./assets/img/avatars/1.png);">
                                </div>
                            ...
                            <div class="col-12 col-md-6  mb-3">
                              <label class="form-label" for="basic-default-email">البريد الاكترونى  </label>
                              <input type="email" class="form-control" id="basic-default-email" placeholder="   البريد الاكترونى">
                            </div>
                            <div class="col-12 col-md-6  mb-3">
                              <label class="form-label" for="basic-default-pass">كلمة المرور  </label>
                              <input type="password" class="form-control" id="basic-default-pass" placeholder="   كلمة المرور">
                            </div>
                           
                            <div class="col-12 col-md-6  mb-3">
                              <label class="form-label" for="basic-default-password">  تاكيدكلمة المرور</label>
                              <input type="password" class="form-control" id="basic-default-password" placeholder="   ************">
                            </div>
