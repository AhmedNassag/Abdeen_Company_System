              ...
              <div class="row mx-0">
                 <!--المهام الشخصيه-->
                   <div class="col-lg-6 mb-4 order-md-0 order-lg-0">
                      <div class="card comonent-hader-top h-100">
                        <div class="card-header">
                          <div class="card-title mb-0">
                            <h5 class="mb-0">المهام الشخصية </h5>
                          </div>
                        </div>
                        <div class="card-body scrollable-c">
                 ...
                 <div class="col-lg-6 mb-4 order-md-0 order-lg-0">
                  <div class="card comonent-hader-top h-100">
                    <div class="card-header">
                      <div class="card-title mb-0">
                        <h5 class="mb-0">المهام المفتوحة </h5>
                      </div>
                    </div>
                    <div class="card-body scrollable-c">
                      <div class="card-datatable text-nowrap  table-responsive">
                 ...
                 <div class="col-lg-6 mb-4 order-md-0 order-lg-0">
                  <div class="card comonent-hader-top h-100">
                    <div class="card-header">
                      <div class="card-title mb-0">
                        <h5 class="mb-0"> الاشعارات </h5>
                      </div>
                    </div>
                    
                      <div class="card-body">
                          <div class="dropdown-notifications-list scrollable-container scrollable-c ps ps__rtl">
                            <ul class="list-group list-group-flush">
                              <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                  <div class="flex-shrink-0 me-3">
                 ...
                 <!--الاشعارات-->
                  ...
                  <div class="col-lg-6 mb-4 order-md-0 order-lg-0">
                   ...
                   <!--الطلبات-->
                     <!--المواعيد-->
                  <div class="col-lg-12 mb-4 order-md-0 order-lg-0">
                    <div class="card comonent-hader-top h-100">
                      <div class="card-header">
                        <div class="card-title  mb-0">
                            ...
                            <table class=" table table-bordered table-hover rounded table-center">
                              <thead class="table-light">
                                <tr>
                                  ...
                                  <th>   اسم العميل </th>
                                  <th>    رقم   الجوال</th>
                                  <th>    بيانات التركيب او الصيانة</th>
                                  <th>    الموقع</th>
