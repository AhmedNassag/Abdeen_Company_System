                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-12">
                            <strong class="py-md-3 px-md-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  عرض تقرير المهام اليومي</span>  </strong>

                          </div>
                          <div class="col text-end">
                            <a href="task-report" class="btn btn-primary waves-effect waves-light btn-add"> رجوع</a>
