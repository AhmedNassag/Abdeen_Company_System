      ...
      <div class="layout-container">
        ...
        <!-- Layout container -->
                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-md-8 col-12  mb-md-4 mb-2 ">
                            <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">المعدات</span>  </strong>


                          </div>
                          <div class="col text-end">
                            <a href="hardware" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
                    ...
                    <div class="card comonent-hader-top p-md-5 p-2 mt-4">
                      <form class="row component-form">
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-default-fullname"> اسم المصنع</label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder=" اسم المصنع" disabled>
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="select-type"> انواع المعدات</label>
                          <div class="input-groupe">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleBranch" tabindex="-1">
                              <i class="fa-solid fa-plus"></i>
                            </button>
                            <select id="select-type" class="select2 form-select" data-allow-clear="true">
                              <option value="AK">   انواع المعدات   </option>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="select1Basic-driver">اختار المعدة</label>
                          <div class="input-groupe">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#He-chosen"data-dismiss="modal">
                              <i class="fa-solid fa-plus"></i>
                            </button>
                            <select id="select1Basic-driver" class="select2 form-select" data-allow-clear="true">
                              <option value="AK">  اختار المعدة   </option>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-default-namber">  رقم التسلسلى</label>
                          <input type="text" class="form-control" id="basic-default-namber" placeholder="  رقم التسلسلى" >
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-default-year">سنة الصنع</label>
                          <input type="text" class="form-control" id="basic-default-year" placeholder="سنة الصنع ">
    
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-default-country "> بلد المنشأ</label>
                          <input type="text" class="form-control" id="basic-default-country " placeholder=" بلد المنشأ ">
    
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-default-line2"> مدة الصيانة الدورية</label>
                          <input type="text" class="form-control" id="basic-default-line2" placeholder=" مدة الصيانة الدورية ">
    
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="select-branch"> اسم الفرع</label>
                          <div class="input-groupe">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-pranh">
                              <i class="fa-solid fa-plus"></i>
                            </button>
                          <select id="select-branch" class="select2 form-select" data-allow-clear="true">
                            <option value="AK"> اسم الفرع  </option>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                          <label class="form-label" for="basic-quntenty"> الكمية  </label>
                          <input type="text" class="form-control" id="basic-quntenty" placeholder=" الكمية">
    
                        </div>
                        <div class="col-12 col-lg-12 mb-3">
                          <label class="form-label" for="basic-notes"> الملاحظات  </label>
                          <textarea type="text" class="form-control" id="basic-notes" placeholder="   الملاحظات "></textarea>
            ...
            <div class="modal fade" id="exampleBranch" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"role="dialog" style="z-index: 1600;">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">اضافة  نوع المعدة</h1>
                  ...
                  <div class="modal-body">
                    <form class="row component-form align-items-end mx-0">
                      ...
                      <div class="col-12 col-lg-12  mb-3">
                        <label class="form-label" for="basic-name-hardware">   اسم المعدة   (عربى)</label>
                        <input type="text" class="form-control" id="basic-name-hardware">

                      </div>
                      <div class="col-12 col-lg-12  mb-3">
                        <label class="form-label" for="basic-name-hardware-e">    اسم المعدة  (انجيلزي)</label>
              ...
              <!-- Modal  اختار المعدات-->
              <div class="modal fade" id="He-chosen" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">  اختيار المعدات </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form class="row component-form align-items-end mx-0">
               ...
               <!-- Modal  اختار الفرع-->
               <div class="modal fade" id="add-pranh" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">  اختيار الفرع </h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form class="row component-form align-items-end mx-0">
                        ...
                        <div class="col-12 col-lg-12  mb-3">
                          <label class="form-label" for="basic-name-hardware">   اسم الفرع   (عربى)</label>
                          <input type="text" class="form-control" id="basic-name-hardware">
  
                        </div>
                        <div class="col-12 col-lg-12  mb-3">
                          <label class="form-label" for="basic-name-hardware-e">    اسم الفرع  (انجيلزي)</label>
                          <input type="text" class="form-control" id="basic-name-hardware-e">
