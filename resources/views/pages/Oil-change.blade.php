               ...
               <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      ...
                      <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">    غيار الزيت</span>  </strong>
                            ...
                            <div class="row h-100 align-items-center">
                              ...
                              <div class="col-sm-7 col-12">
                                <div class="card-body text-sm-end text-center ps-sm-0">
                                  <a href="add-Oil-change" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                   اضافة  غيار الزيت
                                  </a>
                                  <p class="mb-0 mt-1">Add Oil change, if it does not exist</p>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        <thead class="table-light">
                          <tr>
                            ...
                            <th>م</th>
                            <th>   اسم المعدة او رقم الشاحنة </th>
                            <th>   التاريخ</th>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-1 p-md-3">
                  <div class="modal-header px-md-2 px-1">
                    <h1 class="modal-title fs-4 fw-bold text-tilte-b">     تعديل غيار الزيت</h1>
                  ...
                  <div class="modal-body px-md-2 px-1">
                    <form class="row mx-0">
                      ...
                      <div class="mb-3 col-md-6 col-xl-6 col-12 mb-0">
                        <label class="form-label" for="form-repeater-1">   عدد كيلوات تغيير الزيت <span class="start-form">*</span></label>
                        <input type="text" id="form-repeater-1" class="form-control" placeholder="  عدد كيلوات تغيير الزيت " />
                      </div>
                      <div class="mb-3 col-md-6 col-xl-6  col-12 mb-0">
                        <label class="form-label" for="form-repeater">  مسؤول الصيانة<span class="start-form">*</span></label>
                        <select id="form-repeater" class="form-select">
