      ...
      <div class="layout-container">
        ...
        <!-- Layout container -->
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        ...
                        <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">    الزيارات الخارجية</span>  </strong>

                       <!---->
                       <div class="row  mx-0 justify-content-center  py-3 px-md-3 px-2">
                            ...
                            <div class="row h-100">
                              ...
                              <div class="col-sm-7 col-12">
                                <div class="card-body text-sm-end text-center ps-sm-0">
                                  <a href="add-Externalvisits"  class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                   اضافة زيارة
                                  </a>
                                  <p class="mb-0 mt-1">Add Externalvisits, if it does not exist</p>
                                </div>
                              </div>
                            </div>
                          </div>
                   ...
                   <div class="card comonent-hader-top mt-4 p-2">
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td> 	 	</td>
                              <td> 	
                                <a class=" text-bg-success p-1  me-3 rounded cursor-pointer" data-bs-target="#add-comment" data-bs-toggle="modal" title="اضافه"><i class="ti ti-plus  fs-4"></i> </a>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header">
                  <h1 class="modal-title fs-4 fw-bold text-tilte-b">        زيارة خارجية جديدة
                  </h1>
                ...
                <div class="modal-body px-md-2 px-1">
                  <form class="row component-form">
                    ...
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-line-x">  الشخص المسئول
                      </label>
                      <input type="text" class="form-control" id="basic-default-line-x" placeholder="   الشخص المسئول  ">
                    </div>
                    <div class="col-12 col-md-6 mb-3">
                        
                      <label for="select1Basic-driver-v" class="form-label">     
                        الحالة
                      </label>
                      <select id="select1Basic-driver-v" class="select2 form-select" data-allow-clear="true">
                        <option value="AK">   مطلوب عرض سعر</option>
                    ...
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-number-file">   التاريخ</label>
                      <input type="date" class="form-control" id="basic-default-number-file" >
                    </div>
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-line-y"> العنوان </label>
                      <input type="text" class="form-control" id="basic-default-line-y" placeholder="    العنوان ">
                    </div>
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-user-m">   
                        البريد الالكتروني

                      </label>
                      <input type="text" class="form-control" id="basic-default-user-m" placeholder="  البريد الالكتروني ">
                    </div>
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-number"> 1رقم التليفون</label>
                      <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم التليفون  ">
                    </div>
                    <div class="col-12 col-md-6  mb-3">
                      <label class="form-label" for="basic-default-number">2 رقم التليفون</label>
                      <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم التليفون  ">
                    </div>
                  ...
                  <div class="col-12 col-md-12  mb-3">
                    <label class="form-label" for="basic-default-number-file">   ملاحظات</label>
                    <textarea type="text" class="form-control" id="basic-default-number-file " rows="3"></textarea>
                  </div>
                    <div class="col-12 col-lg-8">
                      ...
                      <a href="all-Externalvisits" class="btn btn-label-secondary waves-effect mx-md-3 mx-2 mt-md-0 mt-1">مشاهدة الكل</a>
                     </div>
          ...
          <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header px-md-2 px-1">
                  <h1 class="modal-title fs-5 fw-bold text-tilte-b">     تعديل الزيارات الخارجية</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-md-2 px-1">
                  <form class="row component-form">
           ...
           <!---->
            <!-- اضافه ملاحظة جديدة -->
          <div class="modal fade " id="add-comment" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 fw-bold text-tilte-b">       اضافه ملاحظه جديدة</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-md-2 px-1">
                  <form class="row component-form">
                  ...
                  <div class="col-12 col-md-12  mb-3">
                    <label class="form-label" for="basic-default-number-file">   إضافة ملاحظة</label>
                    <textarea type="text" class="form-control" id="basic-default-number-file " rows="3"></textarea>
                  </div>
                    <div class="col-12 col-lg-8">
                      <button type="submit" class="btn btn-primary  waves-effect waves-light">حفظ</button>
