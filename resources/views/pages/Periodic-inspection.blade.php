...
<html
  ...
  <head>
    ...
    <title>league-Examination</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2   card-widget-separator">
                            ...
                            <strong class="py-md-3 px-md-0  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">    الفحص الدورى </span>  </strong>
                                  ...
                                  <div class="row h-100 ">
                                    ...
                                    <div class="col-sm-7 col-124">
                                      <div class="card-body text-sm-end text-center ps-sm-0">
                                        <a href="add-Periodic-inspection" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                          اضافة فحص
                                        </a>
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        <thead class="table-light">
                          <tr>
                            ...
                            <th>    التاريخ </th>
                            <th>نقطة الفحص(عربى)</th>
                            <th>نقطة الفحص(انجيلزى)</th>
                            <th>Action</th>
                          </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-1 p-md-3">
                <div class="modal-header px-md-2 px-1">
                  <h1 class="modal-title fs-5 fw-bold text-tilte-b">     تعديل  نموذج الفحص  الدورى
                  </h1>
                ...
                <div class="modal-body px-md-2 px-1">
                  <form class="row component-form align-items-end mx-0">
                    <div class="col-12 col-md-6  mb-4">
                      <label class="form-label" for="basic-technician-type">اسم الفحص  </label>
                    ...
                    <div class="col-12 col-md-6  mb-4">
                      <label class="form-label" for="basic-user-name">اسم الشخص  </label>
                      <select id="basic-user-name" class="select2 form-select" data-allow-clear="true">
                        <option value="pm">    احمد	</option>
                        <option value="CM">      محمد </option>
                    

                      </select> 
                    </div>
                    <div class="col-12 col-md-6  mb-4">
                      <label class="form-label" for="basic-technician-type"> المدة  </label>
                      <select id="basic-technician-type" class="select2 form-select" data-allow-clear="true">
                    ...
                    <div class="col-12 col-md-6  mb-4">
                      <label class="form-label" for="basic-default-date"> التاريخ </label>
                    ...
                    <div class="table-responsive mb-3 mt-3">
                      ...
                      <tbody>
                        <tr>
                          <td>1</td>
                          <td>
                            <textarea type="text" class="form-control" id="basic-point-e" placeholder="  نقطة الفحص" rows="1"></textarea>

                          </td>
                          <td>
                            <textarea type="text" class="form-control" id="basic-point-a" placeholder="  نقطة الفحص" rows="1"></textarea>
                          ...
                          <td>
                            <textarea type="text" class="form-control" id="basic-comment" placeholder="الملاحظات" rows="1"></textarea>
