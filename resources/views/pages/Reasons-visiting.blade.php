                   ...
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2  card-widget-separator">
                        <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-md-8  mb-md-0 mb-md-4 mb-2">
                            <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  اسباب الزيارة</span>  </strong>

                          </div>
                          <div class="col text-end">
                            <a data-bs-target="#addtruck" data-bs-toggle="modal" class="btn btn-primary waves-effect waves-light btn-add">اضافه زيارة</a>
            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 fw-bold text-tilte-b">     اضافه اسباب الزيارة</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-md-2 px-0">
                  <form class="row component-form">
                    <div class="col-12 col-lg-12 mb-3">
                      <label class="form-label" for="basic-default-name">السبب  </label>
                      <textarea type="text" class="form-control" id="basic-default-name" placeholder="   السبب" rows="4"></textarea>
                    </div>
           ...
           <!---->
            ...
            <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
              <div class="modal-dialog modal-md modal-dialog-centered">
                <div class="modal-content p-3 p-md-3">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5 fw-bold text-tilte-b">      تعديل  اسباب الزيارة</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body px-md-2 px-0">
                    <form class="row component-form">
