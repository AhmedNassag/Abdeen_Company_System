                      ...
                      <div class="card-body py-2 px-md-4 px-2   card-widget-separator">
                            <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                              ...
                              <div class="col text-end">
                                <a href="Add-Review-Maintenance" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
                        ...
                        <div class="table-responsive mb-3">
                          ...
                          <tbody>
                            <tr>
                              <td>1</td>
                              <td>
                                <textarea type="text" class="form-control" id="basic-name" placeholder="   نشاط الصيانة"></textarea>

                              </td>
                              <td>
                                <textarea type="text" class="form-control" id="basic-name-e" placeholder="   نشاط الصيانة"></textarea>
