    ...
    <div class="layout-container">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <div class="card comonent-hader-top">
              <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                  <div class="col">
                    <strong class="py-md-3 px-md-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">
                        مواقع العمل </span> </strong>

                  </div>
                  <div class="col text-end">
                    <a data-bs-target="#addtruck" data-bs-toggle="modal"
                      class="btn btn-primary waves-effect waves-light btn-add">اضافه موقع</a>
            ...
            <div class="card comonent-hader-top mt-4 p-4">
              <!---->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header">
              <h1 class="modal-title fs-4 fw-bold text-tilte-b"> إضافة موقع جديد</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body  px-md-3 px-1">
              <form class="row component-form">
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-name">اسم الشركة </label>
                  <input type="text" class="form-control" id="basic-default-name" placeholder="   اسم الشركة">
                </div>
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-work">الموقع </label>
                  <input type="text" class="form-control" id="basic-default-work" placeholder="   الموقع">
                </div>
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-user-work">الشخص المسئول </label>
                  <input type="text" class="form-control" id="basic-default-user-work" placeholder="   الشخص المسئول">
                </div>
                <div class="col-12 col-md-6  mb-3">
      ...
      <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header">
              <h1 class="modal-title fs-4 fw-bold text-tilte-b"> تعديل موقع</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-md-3 px-1">
              <form class="row component-form">
