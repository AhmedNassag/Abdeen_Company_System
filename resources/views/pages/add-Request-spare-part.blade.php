...
<head>
  ...
  <title>Request-spare-part</title>
...
<body>
  ...
  <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
    <div class="layout-container">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                  <div class="col col-md-8 col-12  mb-md-4 mb-2 ">
                    <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">
                        طلب قطع غيار</span> </strong>


                  </div>
                  <div class="col text-end">
                    <a href="Request-spare-part" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة
                      الكل</a>
            ...
            <div class="card comonent-hader-top p-2 mt-4">
              <form class="form-repeater row mx-0">
                <div class="mb-3 col-lg-4 col-md-6 col-12 mb-0">
                  <label class="form-label" for="form-repeater-1-4"> الجهه<span class="start-form">*</span></label>
                  <div class="input-groupe">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Theside"
                      tabindex="-1">
                ...
                <div data-repeater-list="group-a">
                  <div data-repeater-item class="col-lg-12">
                    <div class="row">


                      <div class="mb-3 col-lg-4 col-md-6  col-12 mb-0">
                        <label class="form-label" for="form-repeater"> الصنف<span class="start-form">*</span></label>
                        <div class="input-groupe">
                          ...
                          <select id="form-repeater" class="form-select">
                            <option value="Designer"> اختر الصنف</option>
                            <option value="Developer">Developer</option>
                            <option value="Tester">Tester</option>
                            <option value="Manager">Manager</option>
                          </select>
                      ...
                      <div class="mb-3 col-md-5 col-lg-4  col-12 mb-0">
                        <label class="form-label" for="form-repeater-1"> الكمية<span class="start-form">*</span></label>
                        <input type="text" id="form-repeater-1" class="form-control" placeholder="  الكمية" />
                      </div>

                      <div class="mb-3 col-md-2 col-xl-2 col-12 d-flex align-items-center mb-0">
      ...
      <!--/ Content -->
      <!-- Modal   اضافه الجهة-->
      <div class="modal fade" id="Theside" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        role="dialog" style="z-index: 1600;">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">اضافة الجهة</h1>
            ...
            <div class="modal-body">
              <form class="row component-form align-items-end mx-0">
                ...
                <div class="col-12 col-lg-12  mb-3">
                  <label class="form-label" for="basic-name-hardware"> اسم الجهة (عربى)</label>
                  <input type="text" class="form-control" id="basic-name-hardware">

                </div>
                <div class="col-12 col-lg-12  mb-3">
                  <label class="form-label" for="basic-name-hardware-e"> اسم الجهة (انجيلزي)</label>
 ...
 <div class="modal-dialog">
   <div class="modal-content">
     <div class="modal-header">
       <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel">اضافة الصنف</h1>
       <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
     </div>
     <div class="modal-body">
       <form class="row component-form align-items-end mx-0">
         ...
         <div class="col-12 col-lg-12  mb-3">
           <label class="form-label" for="basic-name-hardware"> اسم الصنف (عربى)</label>
           <input type="text" class="form-control" id="basic-name-hardware">

         </div>
         <div class="col-12 col-lg-12  mb-3">
           <label class="form-label" for="basic-name-hardware-e"> اسم الصنف (انجيلزي)</label>
           <input type="text" class="form-control" id="basic-name-hardware-e">
