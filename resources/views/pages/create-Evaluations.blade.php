                    ...
                    <div class="col-xl">
                      <div class="card mb-4">
                        <div class="card-body p-4">
                          <strong class=" mb-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">التقيبم</span>   </strong>
                          <p class="pt-2 pb-2 mt-3 fs-4"> هيا بنا نبدا تقييم جديد</p>
                                ...
                                <div class="row h-100 align-items-center">
                                  <div class="col-sm-5">
                                    <div class="d-flex align-items-end h-100 justify-content-center mt-sm-0 mt-3">
                                      <img src="./assets/img/illustrations/rev.jpg" class="img-fluid mt-sm-4 mt-md-0" alt="add-new-roles" width="300">
    
                                    </div>
                                  </div>
                                  <div class="col-sm-7">
                                    <form class="row component-form  mt-4 pt-4 align-items-center justify-content-center">
                                      <div class="mb-3 col-lg-11 col-xl-10 col-11">
                                        <label class="form-label" for="form-repeater-LIST">   اسم التقيبم<span class="start-form">*</span></label>
                                        <input type="text" id="form-repeater-LIST" class="form-control" />
                                      </div>
                                      <div class="mb-3 col-lg-11 col-xl-10 col-11">
                                        
                                          <label for="select2Basic" class="form-label">اسم المحطة</label>
                                      ...
                                      <div class="mb-3 col-lg-11 col-xl-10 col-11">
                                        <label class="form-label" for="form-repeater-LIST">    تاريخ التقييم<span class="start-form">*</span></label>
                                        <input type="date" id="form-repeater-LIST" class="form-control" />
                                      </div>
                                      <div class="mb-3 col-lg-11 col-xl-10 col-11">
                                        <label class="form-label" for="exampleFormControlTextarea1">ملاحظات<span class="start-form">*</span></label>
