      ...
      <div class="layout-container">
        ...
        <!-- Layout container -->
               ...
               <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      ...
                      <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  الموظفين</span>  </strong>

                       <!----> 
                        <div class="row   justify-content-center mx-0  py-3 px-md-3 px-2">
                          <div class="col-xl-6 col-lg-6 col-md-12 mb-md-0 mb-2">
                            <div class="card h-100 card-border-shadow-gray ">
                              <div class="row h-100 align-items-center">
                                ...
                                <div class="col-sm-7 mt-md-0 mt-4">
                                  <div class="card-body text-sm-end text-center ps-sm-0">
                                    <button data-bs-target="#add-employees" data-bs-toggle="modal" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                     اضافة موظفين
                                    </button>
                                    <p class="mb-0 mt-1">Add employees, if it does not exist</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="card-datatable text-nowrap  table-responsive pt-3">
                      ...
                      <table class="table table-bordered table-hover rounded table-center">
                        ...
                        <tbody>
                            <tr>
                              <td>1</td>
                              <td>محمد مصطفى السيد	</td>
                              <td>mohamedmostafa@raitotec.com	</td>
                              <td>دعم فني	</td>
                              <td>100</td>
                              <td>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-3 p-md-3">
                  <div class="modal-header">
                    <h1 class="modal-title fs-4 fw-bold text-tilte-b">     تعديل موظف</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body px-md-2 px-0">
                    <form class="row component-form align-items-end">
                      <div class="col-12 col-md-4  mb-3">
                        <label class="form-label" for="basic-default-name">الإسم  </label>
                        <input type="text" class="form-control" id="basic-default-name" placeholder="   الإسم">
                      </div>
                      <div class="col-12 col-md-4  mb-3">
                        <label class="form-label" for="basic-default-jop">الوظيفة  </label>
                        <input type="text" class="form-control" id="basic-default-jop" placeholder="   الوظيفة">
                      </div>
                      <div class="col-12 col-md-4  mb-3">
                        <label class="form-label" for="basic-default-selery">الراتب  </label>
                        <input type="text" class="form-control" id="basic-default-selery" placeholder="   الراتب">
                      </div>
                      <div class="col-12 col-md-4  mb-3">
                        <label class="form-label" for="basic-default-user">اسم المستخدم</label>
                        <input type="text" class="form-control" id="basic-default-user" placeholder="   اسم المستخدم ">
                      </div>
                      
                      <div class="col-12 col-md-4  mb-3">
                        <label class="form-label" for="basic-default-user"> كلمة المرور</label>
                        <input type="password" class="form-control" id="basic-default-user" placeholder="   ************">
                      </div>
                      <div class="col-12 col-md-4 mb-3">
                          
                        <label for="select1Basic-users" class="form-label">   مجموعة المستخدمين
                        </label>
                        <select id="select1Basic-users" class="select2 form-select" data-allow-clear="true">
                          <option value="AK">  المجموعه</option>
                          <option value="HI"> المدير العام</option>
                          <option value="CA">موظف </option>
                          <option value="NV">مشرف</option>
                    ...
                    <div class="col-12 col-md-8  mb-3">
                      <label class="form-label" for="basic-default-file">  اضافه صوره</label>
            ...
            <div class="modal fade" id="closeRoleModal" tabindex="-1" aria-hidden="true">
             ...
             <!-- Modal   اضافه المستخدم-->
             <div class="modal fade" id="add-employees" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"role="dialog" style="z-index: 1600;">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-4" id="exampleModalLabel">اضافة   موظف</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form class="row component-form align-items-end">
                      ...
                      <div class="col-12 col-md-4 mb-3">
                        ...
                        <label for="select1Basic-driver" class="form-label">   مجموعة المستخدمين
                        </label>
