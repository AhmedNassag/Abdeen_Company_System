...
<body>
  ...
  <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
    <div class="layout-container">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                  <div class="col col-md-8 col-12  mb-md-4 mb-2 ">
                    <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">
                        غيار الزيت</span> </strong>


                  </div>
                  <div class="col text-end">
                    <a href="Oil-change" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
            ...
            <div class="card comonent-hader-top  p-md-5 p-2 mt-4">
              <form class="row mx-0">
                <div class="mb-3 col-md-6 col-xl-6 col-12 mb-0">
                  <label class="form-label" for="form-repeater-1-4"> المعدات<span class="start-form">*</span></label>
                  <div class="input-groupe">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-hardware">
                      <i class="fa-solid fa-plus"></i>
                    </button>
                  <select id="form-repeater-1-4" class="form-select select2">
                    <option value="all">اختر المعدات او الشاحنة</option>
                    <option value="Developer">معدة:موزع الوقود</option>
                    <option value="Tester">معدة:موزع الوقود</option>
                    <option value="Manager">معدة:موزع الوقود</option>
                  </select>
                  </div>
                </div>
                <div class="mb-3 col-md-6 col-xl-6 col-12 mb-0">
                ...
                <div class="mb-3 col-md-6 col-xl-6 col-12 mb-0">
                  <label class="form-label" for="form-repeater-1"> عدد كيلوات تغيير الزيت <span
                      class="start-form">*</span></label>
                  <input type="text" id="form-repeater-1" class="form-control"
                    placeholder="  عدد كيلوات تغيير الزيت " />
                </div>
                <div class="mb-3 col-md-6 col-xl-6  col-12 mb-0">
                  <label class="form-label" for="form-repeater"> مسؤول الصيانة<span class="start-form">*</span></label>
                  <div class="input-groupe">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-Maintenance">
                      <i class="fa-solid fa-plus"></i>
                    </button>
                  <select id="form-repeater" class="form-select select2">
                    <option value="Designer"> اختر الموظف</option>
                    <option value="Developer">محمد مصطفى </option>
                    <option value="Tester">بدر</option>
                    <option value="Manager">مستخدم جديد</option>
                  </select>
                </div>
                </div>
      ...
      <!-- Add Hardware Modal -->
     <!-- Modal  اختار المعدة-->
     <div class="modal fade" id="add-hardware" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">  اختيار المعدة </h1>
      ...
      <!---->
 <!-- Modal  اختار المعدة-->
 <div class="modal fade" id="add-Maintenance" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">   مسؤول الصيانة </h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form class="row component-form align-items-end mx-0">
          ...
          <div class="col-12 col-lg-12  mb-3">
            <label class="form-label" for="basic-name-hardware">   اسم مسؤول الصيانة   (عربى)</label>
            <input type="text" class="form-control" id="basic-name-hardware">

          </div>
          <div class="col-12 col-lg-12  mb-3">
            <label class="form-label" for="basic-name-hardware-e">    اسم مسؤول الصيانة  (انجيلزي)</label>
            <input type="text" class="form-control" id="basic-name-hardware-e">
