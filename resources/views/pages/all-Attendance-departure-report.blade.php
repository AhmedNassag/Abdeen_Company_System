...
<html
  ...
  <head>
    ...
    <title>all-Attendance-departure-report</title>
                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-12">
                            <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   تقرير الحضور والانصراف
                            </span>  </strong>

                          </div>
                          <div class="col text-end">
                            <a href="Attendance-departure-report" class="btn btn-primary waves-effect waves-light btn-add"> رجوع</a>
