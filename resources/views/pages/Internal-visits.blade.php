...
<body>
                      ...
                      <div class="row h-100 ">
                        <div class="col-sm-5 col-12">
                          <div class="d-flex align-items-end h-100 justify-content-center mt-sm-0 mt-3">
                            <img src="./assets/img/illustrations/add-icon.png" class="img-fluid mt-sm-4 mt-md-0"
                              alt="add-new-roles" width="100">

                          </div>
                        </div>
                        <div class="col-sm-7 col-124">
                          <div class="card-body text-sm-end text-center ps-sm-0">
                            <a href="add-Internal-visits"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header px-md-2 px-1">
              <h1 class="modal-title fs-4 fw-bold text-tilte-b">
                زيارة داخلية جديدة
            ...
            <div class="modal-body px-md-2 px-1">
              <form class="row component-form">
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-name"> الاسم
                  </label>
                  <input type="text" class="form-control" id="basic-default-name" placeholder="     الاسم  ">
                </div>
                <div class="col-12 col-md-6  mb-3">
                ...
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-number"> رقم الهاتف 1 </label>
                  <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم الهاتف 1 ">
                </div>
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-number">رقم الهاتف 2</label>
                  <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم الهاتف 2">
                </div>
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-number-file"> تاريخ الزيارة </label>
                  <input type="date" class="form-control" id="basic-default-number-file">
                </div>
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-number-time"> وقت الزيارة </label>
                  <input type="time" class="form-control" id="basic-default-number-time">
                </div>
                <div class="col-12 col-md-12 mb-3">

                  <label for="select1Basic-driver" class="form-label"> سبب الزيارة
                  </label>
 ...
 <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content p-3 p-md-3">
      <div class="modal-header px-md-2 px-1">
        <h1 class="modal-title fs-4 fw-bold text-tilte-b">     تعديل الزيارات الداخلية</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body px-md-2 px-1">
        <form class="row component-form">
          ...
          <div class="col-12 col-md-12 mb-3">
            ...
            <label for="select1Basic-driver-v" class="form-label">    سبب الزيارة
            </label>
