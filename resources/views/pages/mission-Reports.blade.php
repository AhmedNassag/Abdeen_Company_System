               ...
               <div class="content-wrapper">
                            ...
                            <ul class="menu-sub">
                              <li class="menu-item">
                                <a href="javascript:void(0)" class="menu-link menu-toggle">
                                  ...
                                  <div data-i18n="hardware/car"> الشاحنات/المعدات</div>
                                </a>
                                <ul class="menu-sub">
                                  <li class="menu-item ">
                                  ...
                                  <li class="menu-item">
                                   ...
                                   <li class="menu-item " >
                                    <a href="all-hardware" class="menu-link">
                                      <div data-i18n="view-hardware"> مشاهدة/المعدات</div>
                                    </a>
                                    </li>
                                    <li class="menu-item">
                                      <a href="all-car" class="menu-link">
                                        <div data-i18n="view-car"> مشاهدة/الشاحنات</div>
                                      </a>
                                    </li>
                                </ul>
                              </li>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-4 card-widget-separator">
                    
                      <strong class="py-3 px-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  تقرير المهام  </span>  </strong>
                            ...
                            <div class="row h-100 align-items-center">
                              <div class="col-sm-5">
                                <div class="d-flex align-items-end h-100 justify-content-center mt-sm-0 mt-3">
                                  <img src="./assets/img/illustrations/invoices.jpg" class="img-fluid mt-sm-4 mt-md-0" alt="add-new-roles" width="300">
        
                                </div>
                              </div>
                              <div class="col-sm-7">
                                <form class="row component-form  mt-4  mb-4 pt-4 align-items-center justify-content-center">
                                  <div class="mb-3 col-lg-11 col-xl-8 col-11 ">
                                    <label class="form-label" for="form-repeater-1">   من تاريخ<span class="start-form">*</span></label>
                                    <input type="date" id="form-repeater-1" class="form-control">
                                  </div>
                                  <div class="mb-3 col-lg-11 col-xl-8 col-11">
                                    <label class="form-label" for="form-repeater">   الى تاريخ<span class="start-form">*</span></label>
                                    <input type="date" id="form-repeater" class="form-control">
                                  </div>
                                 <div class="mb-3 col-11 col-lg-11 col-xl-8">
                                  <a class="btn btn-primary  waves-effect waves-light" href="all-mission-Reports">عرض التقارير</a>
                                 </div>
