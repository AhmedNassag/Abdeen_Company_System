  ...
  <body>
    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                       ...
                       <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                        <div class="col col-md-8 col-12  mb-md-4 mb-2 ">
                          <strong class="py-md-3 px-md-1 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   طلب صيانة </span>  </strong>

                        </div>
                        <div class="col text-end">
                          <a href="Maintenance-request" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
                   ...
                   <div class="card comonent-hader-top p-md-5 p-2 mt-4">
                    <form class="row component-form">
                      <div class="col-12 col-lg-4  mb-3">
                        <label class="form-label" for="basic-default-name">  إسم المشروع
                        </label>
                        <div class="input-groupe">
                          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#name-project">
                            <i class="fa-solid fa-plus"></i>
                          </button>
                          <select id="basic-default-name" class="select2 form-select" data-allow-clear="true">
                            <option value="Ab">     ابو هيثم للعقارات</option>
                            <option value="Ac">      العاصم للعقارات</option>
                      ...
                      <div class="col-12 col-lg-4 mb-3">
                        <label class="form-label" for="basic-default-date">   تاريخ البداء</label>
                        <input type="date" class="form-control" id="basic-default-date">
  
                      </div>
                      <div class="col-12 col-lg-4 mb-3">
                        <label class="form-label" for="basic-Malfunction-number">   رقم العطل</label>
                        <input type="text" class="form-control" id="basic-Malfunction-number">
                      ...
                      <div class="col-12 col-lg-4 mb-3">
                        <label for="validationCustom04" class="form-label">المنطقة	</label>
                        <input type="text" class="form-control" id="validationCustom04" required="">
                        
                      </div>
                      <div class="col-12 col-lg-4 mb-3">
                        <label for="validationCustom05" class="form-label">فریق صیانة أو مقاول	</label>
                        <input type="text" class="form-control" id="validationCustom05" required="">
                        
                      </div>
                      <div class="col-12 col-lg-4  mb-3">
                        <label class="form-label" for="basic-technician-name"> 
                          فني صیانة
                        </label>
                        <select id="basic-technician-name" class="select2 form-select" data-allow-clear="true">
                          <option value="Ab">     محمد	</option>
                          <option value="Ac">     احمد </option>
                      
                        </select>                
                      
                      </div>
                      <div class="col-12 col-lg-4 mb-3">
                        <label for="validationCustom06" class="form-label">  رقم امر العمل</label>
                        <input type="text" class="form-control" id="validationCustom06" required="">
                        
                      </div>
                      <div class="col-12 col-lg-4  mb-3">
                        <label class="form-label" for="basic-technician-type"> 
                          نوع الصيانه
                        </label>
                        <div class="input-groupe">
                          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleBranch">
                            <i class="fa-solid fa-plus"></i>
                          </button>
                        <select id="basic-technician-type" class="select2 form-select" data-allow-clear="true">
                      ...
                      <div class="col-12 col-lg-4 mb-3">
                        <label for="validation-number5" class="form-label"> المبلغ المدفوع</label>
                        <input type="text" class="form-control" id="validation-number5" required="">
                        
                      </div>
                      
                    <div class="col-12 col-lg-4 mb-3">
                      <label class="form-label" for="basic-comment-one">   تفصيل العطل
                      </label>
                      <textarea type="text" class="form-control" id="basic-comment-one " rows="1"></textarea>
                    </div>
                     
                   
                    <div class="col-12 col-lg-4 mb-3">
                      <label class="form-label" for="basic-comment">   سبب العطل</label>
                      <textarea type="text" class="form-control" id="basic-comment " rows="1"></textarea>
                    </div>
                    <div class="col-12 col-lg-4 mb-3">
                      <label class="form-label" for="basic-Work "> 
                        نوع موقع العمل
  
                      </label>
                      <div class="input-groupe">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#type-work">
                          <i class="fa-solid fa-plus"></i>
                        </button>
                        <select id="basic-Work" class="select2 form-select" data-allow-clear="true">
                          <option value="pm">    pm	</option>
                          <option value="CM">      cm </option>
                          <option value="TUV">TUV </option>
                          <option value="Other"> Other </option>
                    ...
                    <div class="col-12 col-lg-4 mb-3">
                      <label for="validation-time" class="form-label">   ساعات العمل المنجزة </label>
                      <input type="time" class="form-control" id="validation-time" required="">
                      
                    </div>
                    <div class="col-12 col-lg-4 mb-3">
                      <label class="form-label" for="basic-comment-one">   العمل المنجز
                      </label>
                      <textarea type="text" class="form-control" id="basic-comment-one " rows="1"></textarea>
                    </div>
        ...
        <!-- Modal   نوع الصيانة-->
        <div class="modal fade" id="exampleBranch" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">  نوع الصيانة </h1>
              ...
              <div class="modal-body">
                <form class="row component-form align-items-end mx-0">
                  ...
                  <div class="col-12 col-lg-12  mb-3">
                    <label class="form-label" for="basic-name-hardware">    نوع الصيانة   (عربى)</label>
                    <input type="text" class="form-control" id="basic-name-hardware">

                  </div>
                  <div class="col-12 col-lg-12 mb-3">
                    <label class="form-label" for="basic-name-hardware-e">     نوع الصيانة  (انجيلزي)</label>
           ...
           <!-- Modal    اسم المشروع-->
        <div class="modal fade" id="name-project" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">   اسم المشروع </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <form class="row component-form align-items-end mx-0">
                  ...
                  <div class="col-12 col-lg-12  mb-3">
                    <label class="form-label" for="basic-name-hardware">     اسم المشروع   (عربى)</label>
                    <input type="text" class="form-control" id="basic-name-hardware">

                  </div>
                  <div class="col-12 col-lg-12 mb-3">
                    <label class="form-label" for="basic-name-hardware-e">      اسم المشروع  (انجيلزي)</label>
                    <input type="text" class="form-control" id="basic-name-hardware-e">
            ...
            <!-- Modal     نوع موقع العمل-->
        <div class="modal fade" id="type-work" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">    موقع العمل </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <form class="row component-form align-items-end mx-0">
                  ...
                  <div class="col-12 col-lg-12  mb-3">
                    <label class="form-label" for="basic-name-hardware">      موقع العمل   (عربى)</label>
                    <input type="text" class="form-control" id="basic-name-hardware">

                  </div>
                  <div class="col-12 col-lg-12 mb-3">
                    <label class="form-label" for="basic-name-hardware-e">       موقع العمل  (انجيلزي)</label>
                    <input type="text" class="form-control" id="basic-name-hardware-e">
