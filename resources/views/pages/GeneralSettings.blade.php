                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                            <strong class="py-md-3 px-md-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   الإعدادات العامة </span>  </strong>
                       <!---->
                       <div class="row mx-0  py-3 px-md-3 px-2 justify-content-center ">
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-md-0 mb-2">
                          <div class="card h-100 card-border-shadow-gray ">
                            <div class="row h-100 align-items-center">
                              ...
                              <div class="col-sm-7 col-12 mt-md-0 mt-4">
                                <div class="card-body text-sm-end text-center ps-sm-0">
                                  <a href="add-GeneralSettings" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                   اضافة اعدادت
                                  </a>
                                  <p class="mb-0 mt-1">Add GeneralSettings, if it does not exist</p>
                                </div>
                              </div>
                            </div>
                          </div>
                   ...
                   <div class="card comonent-hader-top mt-4 p-3">
                    <div class="card-datatable text-nowrap  table-responsive pt-3">
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        ...
                        <tbody>
                            <tr>
                              <td>1</td>
                              <td>  30.119466199999998	</td>
                              <td>31.341039599999995	</td>
                              <td> 10	 	</td>
                              <td>نظام رايتو المحاسبي</td>
                              <td>مقر الشركة</td>
                              <td>  010037040225	</td>
                              <td>111111	</td>
                              <td> محمد	 	</td>
                              ...
                              <td>محمد</td>
                              <td>
                                <img src="./assets/img/avatars/11.png" alt="img" class="img-table">
                              </td>
                              <td>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-3 p-md-3">
                  <div class="modal-header">
                    <h1 class="modal-title fs-4 fw-bold text-tilte-b">     تعديل اعدادت</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body px-md-2 px-1">
                    <form class="row component-form">
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-line-x"> خط العرض</label>
                        <input type="text" class="form-control" id="basic-default-line-x" placeholder="    خط العرض ">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-line-y">خط الطول </label>
                        <input type="text" class="form-control" id="basic-default-line-y" placeholder="   خط الطول ">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-user-m"> أقصى مسافة للحضور ( متر )
                        </label>
                        <input type="text" class="form-control" id="basic-default-user-m" placeholder="    أقصى مسافة للحضور ( متر ) ">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-name">  إسم الشركة
                        </label>
                        <input type="text" class="form-control" id="basic-default-name" placeholder="    اسم الشركة  ">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-locetion"> العنوان </label>
                        <input type="text" class="form-control" id="basic-default-locetion" placeholder="   العنوان">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-number"> رقم التليفون</label>
                        <input type="text" class="form-control" id="basic-default-number" placeholder="   رقم التليفون  ">
                      </div>
                      <div class="col-12 col-md-6  mb-3">
                        <label class="form-label" for="basic-default-number-tow">  الرقم الضريبى</label>
                        <input type="text" class="form-control" id="basic-default-number-tow" placeholder="  الرقم الضريبى ">
                      </div>
                      <div class="col-12 col-md-6 mb-3">
                          
                        <label for="select1Basic-driver-v" class="form-label">   استشارة مسؤول</label>
                        <select id="select1Basic-driver-v" class="select2 form-select" data-allow-clear="true">
                          <option value="AK">  مستخدم تجريبى</option>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                      ...
                      <label for="select1Basic-driver-seles" class="form-label">    مبيعات مسؤول
                      </label>
                      <select id="select1Basic-driver-seles" class="select2 form-select" data-allow-clear="true">
                        <option value="AK">  مستخدم تجريبى</option>
                        <option value="HI">احمد حمدى</option>
                        <option value="CA">California</option>
                        <option value="NV">Nevada</option>
                  ...
                  <div class="col-12 col-md-6 mb-3">
                    ...
                    <label for="select1Basic-driver-u" class="form-label">     دعم فني مسؤول</label>
                    <select id="select1Basic-driver-u" class="select2 form-select" data-allow-clear="true">
                      <option value="AK">  مستخدم تجريبى</option>
                      <option value="HI">احمد حمدى</option>
                      <option value="CA">California</option>
                      <option value="NV">Nevada</option>
                ...
                <div class="col-12 col-md-6  mb-3">
                  <label class="form-label" for="basic-default-number-file">   الصورة</label>
                  <input type="file" class="form-control" id="basic-default-number-file" >
                </div>
