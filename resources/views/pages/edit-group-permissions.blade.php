                 ...
                 <!-- Content -->
                   <div class="container-xxl flex-grow-1 container-p-y">
                      <div class="card comonent-hader-top">
                         <div class="card-body py-4 px-lg-4 px-md-2 px-1 card-widget-separator">
                          <h4 class="mb-4 fw-bold fs-4 text-center">صلاحيات مجموعه: المدير العام </h4>

                          
                          <!-- Role cards -->
                          <div class="row g-4 mx-lg-4 mx-md-2 mx-1 pt-3">
