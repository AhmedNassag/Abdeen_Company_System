...
<html
  ...
  <head>
    ...
    <title>Weekly-examination</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2   card-widget-separator">
                        ...
                        <strong class="py-md-3 px-md-0  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   تعرفيات الفحص </span>  </strong>
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        <thead class="table-light">
                          <tr>
                            ...
                            <th>م</th>
                            <th>    اسم النموذج(العربى)</th>
                            <th>    اسم النموذج(انجيلزي)</th>
                            <th>   المدة</th>
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content p-3 p-md-3">
              <div class="modal-header">
                <h1 class="modal-title fs-4 fw-bold text-tilte-b">   إضافة  نموذج الفحص</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <form class="row component-form align-items-end mx-0 mt-4">
                  <div class="col-12 col-md-4  mb-4">
                    <label class="form-label" for="basic-default-name">اسم النموذج(عربى)  </label>
                    <input type="text" class="form-control" id="basic-default-name" placeholder="   الإسم">
                  </div>
                  <div class="col-12 col-md-4  mb-4">
                    <label class="form-label" for="basic-default-name">اسم النموذج(انجيلزى)  </label>
                    <input type="text" class="form-control" id="basic-default-name" placeholder="   الإسم">
                  </div>
                  <div class="col-12 col-md-4  mb-4">
                  ...
                  <div class="table-responsive mb-3">
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td>
                          <textarea type="text" class="form-control" id="basic-name" placeholder="  نقطة الفحص"></textarea>

                        </td>
                        <td>
                          <textarea type="text" class="form-control" id="basic-name-e" placeholder="  نقطة الفحص"></textarea>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-1 p-md-3">
                  <div class="modal-header px-md-2 px-1">
                    <h1 class="modal-title fs-5 fw-bold text-tilte-b">     تعديل  نموذج الفحص
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
