    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
        ...
        <!-- Layout container -->
                                    ...
                                    <div class="row h-100">
                                      ...
                                      <div class="col-sm-7 col-12">
                                        <div class="card-body text-sm-end text-center ps-sm-0">
                                          <a href="add-hardware"  class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                        اضافة معدات
                                          </a>
                                          <p class="mb-0 mt-1">Add Hardware, if it does not exist</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="d-flex justify-content-center">
                                  ...
                                  <a class="bg-success text-bg-success p-1 d-flex align-items-center justify-content-center me-3 rounded cursor-pointer" data-bs-target="#editHardwareModal" data-bs-toggle="modal" title="تعديل"><i class="ti ti-pencil  fs-4"></i> </a>
           ...
           <!--edit-hardware-->
           <div class="modal fade " id="editHardwareModal" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header px-md-2 px-1">
                  <h1 class="modal-title fs-5 fw-bold text-tilte-b"> تعديل بيانات المعدة</h1>
                ...
                <div class="modal-body px-md-2 px-1">
                  <form class="row component-form">
                    ...
                    <div class="col-12 col-lg-4 mb-3">
                      <label class="form-label" for="basic-default-model">اختار المعدة</label>
