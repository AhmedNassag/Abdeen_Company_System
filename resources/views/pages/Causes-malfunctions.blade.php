...
<html
  ...
  <head>
    ...
    <title>Causes-malfunctions</title>
                   ...
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2  card-widget-separator">
                        <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-md-8  mb-md-4 mb-2 ">
                            <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">   أسباب الأعطال </span>  </strong>

                          </div>
                          <div class="col text-end">
                            <a data-bs-target="#addtruck" data-bs-toggle="modal" class="btn btn-primary waves-effect waves-light btn-add">اضافه </a>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header px-0">
                  <h1 class="modal-title fs-4 fw-bold text-tilte-b">       إضافة أسباب الأعطال </h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-0">
                  <form class="row component-form">
                    <div class="col-12 col-lg-12 mb-3">
                      <label class="form-label" for="basic-default-name">أسباب الأعطال </label>
                      <textarea type="text" class="form-control" id="basic-default-name" rows="5" placeholder=" أسباب الأعطال"></textarea>
                    </div>
           ...
           <!---->
            ...
            <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true" role="dialog">
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-3 p-md-3">
                  <div class="modal-header px-0">
                    <h1 class="modal-title fs-5 fw-bold text-tilte-b">     تعديل أسباب الأعطال
                    </h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body px-0">
