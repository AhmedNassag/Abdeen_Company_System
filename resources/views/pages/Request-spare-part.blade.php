                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  طلب قطع غيار</span>  </strong>
                            ...
                            <div class="row h-100 align-items-center">
                              ...
                              <div class="col-sm-7 col-12">
                                <div class="card-body text-sm-end text-center ps-sm-0">
                                  <a href="./add-Request-spare-part" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                   اضافة قطعه غيار
                                  </a>
                                  <p class="mb-0 mt-1">Add Request-spare-part, if it does not exist</p>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <div class="modal-dialog modal-md modal-dialog-centered">
              <div class="modal-content p-3 p-md-3">
                <div class="modal-header px-md-2 px-1">
                  <h1 class="modal-title fs-4 fw-bold text-tilte-b">     تعديل طلب قطعة غيار</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body px-md-2 px-1">
                  <form class="form-repeater row mx-0">
                    <div class="mb-3 col-md-12  col-12 mb-0">
                    ...
                    <div class="mb-3 col-md-5 col-md-12  mb-0">
                      ...
                      <input type="date" id="form-repeater-1-1" class="form-control" placeholder="  التاريخ" />
                            ...
                            <div class="mb-3 col-md-6 col-12 mb-0">
