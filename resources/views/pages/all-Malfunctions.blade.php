...
<head>
  ...
  <title>all-Malfunctions-Reports</title>
              ...
              <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                  ...
                  <div class="col text-end">
                    <a href="Malfunctions-tasks" class="btn btn-primary waves-effect waves-light btn-add"> رجوع</a>
                  ...
                  <table class=" table table-bordered table-hover rounded table-center">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <a class="bg-danger text-bg-danger p-1  align-items-center justify-content-center me-3 rounded"
