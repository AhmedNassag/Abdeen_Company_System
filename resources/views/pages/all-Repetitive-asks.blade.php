                      ...
                      <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                        <div class="row mx-0 d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col col-12">
                            <strong class="py-md-3 px-md-3 text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">  تقرير المهام المتكررة
                            </span>  </strong>

                          </div>
                          <div class="col text-end">
                            <a href="all-Repetitive-asks" class="btn btn-primary waves-effect waves-light btn-add"> رجوع</a>
                          ...
                          <tbody>
                              <tr>
                                ...
                                <td></td>
                                 <td></td>
                                 <td>
                                  <a class="bg-danger  text-bg-danger p-1  align-items-center justify-content-center me-3 rounded" href="javascript:void(0);" title="حذف  " data-bs-target="#closeRoleModal"  data-bs-toggle="modal"><i class="ti ti-trash  fs-4"></i> </a>
                                </td>
