    ...
    <div class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
      <div class="layout-container">
        ...
        <!-- Layout container -->
                    ...
                    <div class="card mb-4">
                      <div class="card-body p-4">
                        <div class="row justify-content-between ">
                           <strong class="col-xl-2 col-lg-4 col-md-4 mb-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">اضافه لوجو</span>  </strong>
                              ...
                              <div class="row h-100 align-items-center justify-content-center">
                                <div class="col-sm-5 col-12">
                                  <div class="d-flex align-items-end h-100  justify-content-center mt-sm-0 mt-3">
                                    <img src="./assets/img/illustrations/logo.png" class="img-fluid mt-sm-4 mt-md-0" alt="add-new-roles" width="100">
        
                                  </div>
                                </div>
                                <div class="col-sm-7 col-12  text-center py-md-0 py-2">
                                    <button class="btn btn-primary waves-effect waves-light" data-bs-target="#addlogo" data-bs-toggle="modal">اضافه لوجو</button>
                                    <p class="mb-0 mt-2">Add logo, if it does not exist</p>
                          ...
                          <table class="table table-bordered table-hover rounded">
                            ...
                            <tbody class="table-border-bottom-0">
                              <tr>
                                ...
                                <td class="text-center">   
                                  <img class="img-tabel" src="assets/img/illustrations/add-new-roles.png" alt="">
            ...
            <!--/ Content -->
          <!-- Add logo Modal -->
          <div class="modal fade" id="addlogo" tabindex="-1" aria-hidden="true">
              ...
              <div class="modal-content p-1 p-md-3">
                ...
                <div class="modal-body">
                  <div class="text-center mb-4">
                    <h3 class="role-title mb-2"> اضافه لوجو</h3>
                  </div>
                  <!-- Add quetions form -->
                  <form class="row form-repeater mt-4 justify-content-center">
                          <div class="mb-3 col-lg-8 col-xl-12 col-11 mb-0">
                            <label class="form-label" for="form-repeater-1">   اللوجو<span class="start-form">*</span></label>
                            <input type="file" id="form-repeater-1" class="form-control" />
                          </div>
                        
                         
                            
                      <div class="col-11 col-lg-8 col-xl-12">
           ...
           <div class="modal fade" id="editRoleModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered modal-add-new-role">
              <div class="modal-content p-1 p-md-3">
                ...
                <div class="modal-body">
                  <div class="text-center mb-4">
                    <h3 class="role-title mb-2">  تعديل الوجو</h3>
                  </div>
                  <!---->
