                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-4 card-widget-separator">
                        <div class="row d-flex justify-content-between  mb-3 align-items-center pt-4">
                          <div class="col">
                            <strong class="text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">كل التقيمات</span> </strong>
          
                          </div>
                          <div class="col text-end">
                            <a href="create-Evaluations" class="btn btn-primary waves-effect waves-light">اضافه التقيبم</a>
                        ...
                        <table class="table table-bordered table-hover rounded text-center">
                          <thead class="table-light">
                            <tr class="fw-bold">
                              ...
                              <th class="fw-bold"> التقيبم</th>
                              <th class="fw-bold"> التاريخ</th>
                              <th class="fw-bold">  ملا حظات</th>
                              <th class="fw-bold">  الاحصائيات</th>
                          ...
                          <tbody class="table-border-bottom-0">
                            <tr>
                              ...
                              <td class="pt-4 pb-4">         
                                  <a class="btn-primary  p-2  me-3 rounded" href="all-view-statistics" title="مشاهدة"><i class="ti ti-eye-check  fs-4"></i> مشاهدة الاحصائيات</a>
                              </td>
