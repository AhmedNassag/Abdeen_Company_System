                              ...
                              <div class="row h-100">
                                ...
                                <div class="col-sm-7 col-12">
                                  <div class="card-body text-sm-end text-center ps-sm-0">
                                    <a href="add-Maintenance-request" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                        اضافه الطلب
                                    </a>
                                    <p class="mb-0 mt-1">Add Maintenance, if it does not exist</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        <thead class="table-light">
                          <tr>
                            ...
                            <th>    تفصيل العطل  </th>
                            <th>      سبب العطل</th>
                            <th>     نوع موقع العمل</th>
                            <th> ساعات العمل المنجزة </th>
                            <th>      العمل المنجز </th>
                            <th>Action</th>
                          </tr>
                        </thead>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content p-3 p-md-3">
                  <div class="modal-header px-md-2 px-1">
                    <h1 class="modal-title fs-4 fw-bold text-tilte-b">  تعديل طلب الصيانة    </h1>
