              ...
              <div class="card-body py-2 px-md-4 px-2 card-widget-separator">
                ...
                <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                  ...
                  <div class="col text-end">
                    <a href="Internal-visits" class="btn btn-primary waves-effect waves-light btn-add"> مشاهدة الكل</a>
        ...
        <div class="modal-body">
          <form class="row component-form align-items-end mx-0">
            ...
            <div class="col-12 col-lg-12  mb-3">
              <label class="form-label" for="basic-name-hardware">   اسم 
                سبب الزيارة
                   (عربى)</label>
            ...
            <div class="col-12 col-lg-12  mb-3">
              <label class="form-label" for="basic-name-hardware-e">    اسم 
                سبب الزيارة
                  (انجيلزي)</label>
