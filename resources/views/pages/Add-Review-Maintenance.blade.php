...
<html
  ...
  <head>
    ...
    <title>Add-Review-Maintenance</title>
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                   <div class="card comonent-hader-top">
                      <div class="card-body py-2 px-md-4 px-2   card-widget-separator">
                            <strong class="py-md-3 px-md-3  text-title-hadeer text-tilte-b"><span class="text-muted fw-medium">    قائمة مراجعه الصيانة </span>  </strong>
                                  ...
                                  <div class="row h-100">
                                    ...
                                    <div class="col-sm-7 col-12">
                                      <div class="card-body text-sm-end text-center ps-sm-0">
                                        <a href="Add-addReview-Maintenance" class="btn btn-primary mb-2 text-nowrap add-new-role waves-effect waves-light">
                                          اضافه 
                                        </a>
                      ...
                      <table class=" table table-bordered table-hover rounded table-center">
                        <thead class="table-light">
                          <tr>
                            ...
                            <th>م</th>
                            <th>   اسم مراجعة   (عربى)</th>
                            <th>    اسم مراجعة  (انجيلزي)</th>
                            <th>  اسم المعدة </th>
                            <th> رقم المعدة	</th>
                            <th> رقم القائمة المرجعية</th>
                            <th>   تردد الصيانة</th>
                            <th>نشاط الصيانة(عربى)</th>
                            <th>نشاط الصيانة (انجيلزى)</th>
          ...
          <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content p-1 p-md-3">
              <div class="modal-header  px-md-2 px-1">
                <h1 class="modal-title fs-5 fw-bold text-tilte-b">     تعديل قائمة مراجعه الصيانة
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body px-md-2 px-1">
                <form class="row component-form align-items-end mx-0">
                  <div class="col-12 col-lg-4 col-md-6 mb-3">
                    <label class="form-label" for="basic-Malfunction-name">   اسم مراجعة   (عربى)</label>
                    <input type="text" class="form-control" id="basic-Malfunction-name">

                  </div>
                  <div class="col-12 col-lg-4 col-md-6 mb-3">
                    <label class="form-label" for="basic-Malfunction-name-e">    اسم مراجعة  (انجيلزي)</label>
                    <input type="text" class="form-control" id="basic-Malfunction-name-e">

                  </div>
                  <div class="col-12 col-lg-4  col-md-12  mb-3">
                    <label class="form-label" for="basic-technician-type">اسم المعدة  </label>
                    <select id="basic-technician-type" class="select2 form-select" data-allow-clear="true">
                      <option value="pm">    1	</option>
                      <option value="CM">      1 </option>
                      <option value="TUV">1 </option>
                      <option value="Other"> 1 </option>

                    </select> 
                  </div>
                  <div class="col-12 col-lg-4 col-md-6 mb-3">
                    <label class="form-label" for="basic--namber">    رقم المعدة	</label>
                    <input type="text" class="form-control" id="basic--namber">

                  </div>
          
                  <div class="col-12 col-lg-4 col-md-6 mb-3">
                    <label class="form-label" for="basic-Malfunction-namber">     رقم القائمة المرجعية	</label>
                    <input type="text" class="form-control" id="basic-Malfunction-namber">

                  </div>
                 
                  <div class="col-12 col-md-4  mb-4">
                    <label class="form-label" for="basic-technician-type"> تردد الصيانة  </label>
                    <select id="basic-technician-type" class="select2 form-select" data-allow-clear="true">
                      <option value="day">   يومى	</option>
                      <option value="week">    اسبوعى </option>
                      <option value="TUV">3 شهور </option>
                      <option value="Other">  6شهور </option>
                      <option value="Other">  سنة </option>
                      <option value="Other">  خمس سنين </option>
                    </select> 
                  </div>
                 
                  <div class="col-12 col-md-4  mb-3">
                    <label class="form-label" for="basic-comment-co">     نشاط الصيانة(عربى)</label>
                    <textarea type="text" class="form-control" id="basic-comment-co" rows="1"></textarea>
                  </div>
                  <div class="col-12 col-md-4  mb-3">
                    <label class="form-label" for="basic-comment">   نشاط الصيانة (انجيلزى)</label>
