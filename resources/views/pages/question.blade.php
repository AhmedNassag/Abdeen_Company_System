              ...
              <div class="card mb-4">
                <div class="card-body p-4">
                  <div class="row justify-content-between ">
                    <strong class="col-xl-2 col-lg-4 col-md-4 mb-3  text-title-hadeer text-tilte-b"><span
                        class="text-muted fw-medium">الاسئلة</span> </strong>
                        ...
                        <div class="row h-100 align-items-center">
                          <div class="col-sm-5 col-12">
                            <div class="d-flex align-items-end h-100 justify-content-center mt-sm-0 mt-3">
                              <img src="./assets/img/illustrations/wepik-q.png" class="img-fluid mt-sm-4 mt-md-0"
                                alt="add-new-roles" width="200">

                            </div>
                          </div>
                          <div class="col-sm-7 col-12 text-center py-md-0 py-2">
                            <button class="btn btn-primary waves-effect waves-light" data-bs-target="#addRoleModal"
                              data-bs-toggle="modal">اضافه سوال</button>
                            <p class="mb-0 mt-2">Add questions, if it does not exist</p>
                  ...
                  <div class="table-responsive text-nowrap rounded mt-4">
                    <table class="table table-bordered table-hover rounded">
                      <thead class="table-light">
                        <tr class="fw-bold">
                          <th class="fw-bold">التسلسل</th>
                          <th class="fw-bold"> السوال</th>
                          <th class="fw-bold">النوع</th>
                          <th class="fw-bold"> تعديل</th>
                        </tr>
                      </thead>
                      <tbody class="table-border-bottom-0">
                        <tr>
                          ...
                          <td>هل انت راضى عن الخدمة المقدمة لك؟</td>
                          ...
                          <td class="d-flex w-100 justify-content-center">
                            <a class="bg-success text-bg-success p-1 d-flex align-items-center justify-content-center me-3 rounded cursor-pointer"
                              data-bs-target="#editRoleModal" data-bs-toggle="modal" title="تعديل"><i
          ...
          <div class="modal-content p-1 p-md-3">
            ...
            <div class="modal-body px-md-2 px-1">
              <div class="text-center mb-4">
                <h3 class="role-title mb-2"> اضافه سوال</h3>
              </div>
              <!---->
              <form class="form-repeater">
                <div data-repeater-list="group-a">
                  <div data-repeater-item>
                    <div class="row">
                      <div class="mb-3 col-lg-6 col-xl-5 col-11 ">
                        <label class="form-label" for="form-repeater-1-1"> السوال<span
                            class="start-form">*</span></label>
                        <input type="text" id="form-repeater-1-1" class="form-control" placeholder=" السوال " />
                      </div>

                      <div class="mb-3 col-lg-6 col-xl-5 col-11 mb-0">
                        <label class="form-label" for="form-repeater-1-3">النوع <span
                            class="start-form">*</span></label>
                        <select id="form-repeater-1-3" class="form-select">
                          <option value="Designer"> نعم اولا</option>
                          <option value="Developer">اقتراح لى تحسن الخدمة</option>
                          <option value="Tester">اختيار من متعدد</option>
                          <option value="Manager">تقييم بالنجوم</option>
                          <option value="amoctioon">تقييم بالايموشن</option>
                          <option value="send"> رسالة شكر</option>
                        </select>
                      </div>
                ...
                <div class="col-11 col-lg-12 mb-3">
                  ...
                  <a href="" class="btn btn-label-secondary waves-effect mx-md-2 mx-1"> الرجوع</a>
                </div>
              </form>
              <!-- Add quetions1 form -->
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-add-new-role">
          <div class="modal-content p-1 p-md-3">
            ...
            <div class="modal-body">
              <div class="text-center mb-4">
                <h3 class="role-title mb-2"> تعديل سوال </h3>
              </div>
              <!---->
              <form class="row form-repeater mt-4">
                <div class="mb-3 col-lg-6 col-xl-6 col-12 mb-0">
                  <label class="form-label" for="form-repeater-1-1"> السوال<span class="start-form">*</span></label>
                  <input type="text" id="form-repeater-1-1" class="form-control" placeholder=" السوال " />
                </div>
                <div class="mb-3 col-lg-6 col-xl-6 col-12 mb-0">
                  <label class="form-label" for="form-repeater-1-4">النوع<span class="start-form">*</span></label>
                  <select id="form-repeater-1-4" class="form-select select2">
                    <option value="Designer"> نعم اولا</option>
                    <option value="Developer">اقتراح لى تحسن الخدمة</option>
                    <option value="Tester">اختيار من متعدد</option>
                    <option value="Manager">تقييم بالنجوم</option>
