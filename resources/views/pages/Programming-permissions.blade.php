...
<head>
  ...
  <title>Programming-permissions</title>
    ...
    <div class="layout-container">
                ...
                <div class="row mx-0 d-flex flex-wrap  justify-content-between  mb-3 align-items-center pt-4">
                  ...
                  <div class="col text-end">
                    <a data-bs-target="#addtruck" data-bs-toggle="modal"
                      class="btn btn-primary waves-effect waves-light btn-add">اضافه مستخدم</a>
                ...
                <table class=" table table-bordered table-hover rounded table-center">
                  <thead class="table-light">
                    <tr>
                      ...
                      <th>م</th>
                      <th> اسم المجموعة</th>
                      <th> تعديل صلاحيات المجموعة</th>
                      <th> عرض صلاحيات المجموعة</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td></td>
                      <td>
                        <a href="edit-group-permissions" title="تعديل" class="btn">
                          <i class="menu-icon tf-icons ti ti-file-description"></i>
                        </a>
                      </td>
                      <td>
                        <a data-bs-target="#view-permissions" data-bs-toggle="modal" title="عرض" class="btn">
                          <i class="menu-icon tf-icons ti ti-file-description"></i>
                        </a>
                      </td>
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header px-0">
              <h1 class="modal-title fs-5 fw-bold text-tilte-b"> اضافه مستخدم</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-0">
              <form class="row component-form">
                <div class="col-12 col-lg-12 mb-3">
                  <label class="form-label" for="basic-default-name">اسم المجموعة </label>
                  <input type="text" class="form-control" id="basic-default-name" placeholder="  اسم المجموعة">
                </div>
      ...
      <div class="modal fade " id="edittruck" aria-labelledby="exampleModalToggleLabel" tabindex="-1" aria-modal="true"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header px-0">
              <h1 class="modal-title fs-5 fw-bold text-tilte-b"> تعديل مستخدم</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-0">
              <form class="row component-form">
      ...
      <!-- view  -->
      <div class="modal fade " id="view-permissions" aria-labelledby="exampleModalToggleLabel" tabindex="-1"
        aria-modal="true" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content p-3 p-md-3">
            <div class="modal-header px-0">
              <h1 class="modal-title fs-5 fw-bold text-tilte-b"> صلاحيات المجموعه</h1>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-0">
              <div class="card-datatable text-nowrap  table-responsive pt-3">
